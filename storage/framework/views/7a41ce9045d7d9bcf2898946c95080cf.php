...
<body class="bg-gray-100 text-gray-800 min-h-screen p-6">
    ...
    <footer class="mt-10 text-center text-sm text-gray-500">
        &copy; <?php echo e(date('Y')); ?> - Site desenvolvido por 
    ...
    <div id="modalHenrique" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-lg shadow-lg p-6 max-w-md w-full relative">
            ...
            <p><strong>Ano:</strong> <?php echo e(date('Y')); ?></p>
...
<?php /**PATH C:\xampp\htdocs\desafio_creditos\resources\views/consulta.blade.php ENDPATH**/ ?>